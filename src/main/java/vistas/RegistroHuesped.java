...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		txtNacionalidad.setModel(new DefaultComboBoxModel(new String[] { "argentina", "australiana", "belga-belga", 
				...
				"costarricense-costarricense", "cubano-cubana", "ecuatoriano-ecuatoriana", "egipcio-egipcia",
 "español-española", "estadounidense-estadounidense", "estonio-estonia", "etiope-etiope", "filipino-filipina",
 "griego-griega", "guatemalteco-guatemalteca", "haitiano-haitiana","italiano-italiana","jordano-jordana",
 "laosiano-laosiana", "malayo-malaya","mexicano-mexicana", "noruego-noruega", "paraguayo-paraguaya", 
 "peruano-peruana", "polaco-polaca", "dominicano-dominicana", "rumano-rumana", "ruso-rusa", "sueco-sueca", "suizo-suiza", "tailandes-tailandesa",
 "taiwanes-taiwanesa", "turco-turca", "ucraniano-ucraniana", "uruguayo-uruguaya", "venezolano-venezolana",
